...
void main() {
  ...
  group('DailyNewsApiClient', () {
    late http.Client httpClient;
    late DailyNewsApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = DailyNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => DailyNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = DailyNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws DailyNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<DailyNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws DailyNewsApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<DailyNewsApiRequestFailure>()
